...
const FormToDo = ({ isWaitList, calendarDate, toDoData, getToDoFormData }: { isWaitList?: boolean; calendarDate?: Date; toDoData?: any; getToDoFormData?: (toDoData: any) => void;  }) => {
    ...
    const { register: newToDo, formState: { errors: newToDoErrors }, reset: toDoFormReset, handleSubmit: submitNewToDo, setValue: setNewToDo, getValues: getToDoValues } = useForm(newToDoOptions);
    ...
    useEffect(() => {
        ...
        getToDoFormData?.(getToDoValues());
        submitNewToDo(getToDoValues)
